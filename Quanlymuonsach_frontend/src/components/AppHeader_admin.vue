        ...
        <div class="footer">
            ...
            <ul class="list-unstyled px-2">
                <template v-if="!isLoggedIn">
                    <li>
                        <router-link :to="{ name: 'nhanvien.dangky_admin' }" class="btn" type="button">
                            <i class="fa-regular fa-address-card"></i>
                            <span>Đăng Kí</span>
                        </router-link>
                    </li>
                    <li>
                        <router-link :to="{ name: 'nhanvien.dangnhap_admin' }" class="btn" type="button">
                ...
                <template v-else>
                    ...
                    <li>
                        <a @click="logout" class="btn btn-link nav-link"><i
                                class="fa-solid fa-arrow-right-from-bracket"></i><span>Đăng xuất</span></a>
                    </li>
                </template>
            </ul>
        </div>
...
export default {
    ...
    methods: {
        logout() {
            ...
            this.$router.push({ name: 'nhanvien.dangnhap_admin' });
        },
    }
};
</script>
